             ...
             try {
                ...
                if(response.length === 2){
                    ...
                    setCateEx(findCate.expernameen);
                     ...
                     setFileTemp({...fileTemp , filebase64:"" , fileimg:urlServer+response[1].data.list.experThumb});
                ...
                <Grid item xs={12} sx={{p:2}}>
                    ...
                    <Grid item xs={12} sx={{p:2}}>
                        ...
                        <Grid item xs={12} sx={{pt:2}}>
                        {
                            ...
                            <img src={fileTemp.filebase64 === "" ? fileTemp.fileimg : fileTemp.filebase64} alt="img-main-product" /> 
