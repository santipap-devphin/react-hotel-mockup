...
const BlockRoom = ({rId ,rTitle , rDate , rImg , rDes , SetstatusCompleate , listRoom}) => {
 ...
 const showView = (id) => {
  ...
  return (<>
            ...
            <CardMedia
                component="img"
                height="194"
                image={rImg !== "" ? `http://localhost:7070/${rImg}` : imgblank}
                alt="Paella dish"
            />
            <CardContent>
                {
                    <div key={1} dangerouslySetInnerHTML={{ __html:rDes.substring(0,400) + "....." }} />
                }
            </CardContent>
